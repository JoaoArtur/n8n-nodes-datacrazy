...
const leadsOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				value: 'getActivities',
				description: 'Buscar atividades do lead',
				action: 'Buscar atividades do lead',
			},
			{
				name: 'Buscar Histórico',
				value: 'getHistory',
				description: 'Buscar histórico do lead',
				action: 'Buscar histórico do lead',
			},
			{
		name: 'Buscar Negócios do Lead',
		value: 'getBusinesses',
		description: 'Buscar negócios associados ao lead',
		action: 'Buscar negócios do lead',
	},
		],
		default: 'getAll',
	},
